...
const char* const CFG_FILE_NAME_JSON = "skywar.json";
...
bool GameData::loadData()
{
	...
	m_gameDataDefine.push_back(TGameData(GAMEDATA::DAY_REWARD_LOGIN_DAYS, 1));
...
bool GameData::loadFile()
{
	...
	destPath += CFG_FILE_NAME_JSON;
		...
		DEBUG_LOG("loadJson destPath : %s",destPath.c_str());
