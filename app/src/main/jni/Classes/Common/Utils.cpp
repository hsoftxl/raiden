...
#define LOG_TAG "skywar"

namespace Utils
{
	const char* const LOG_FILE_NAME = "skywar.log";
	...
	int timestamp2int(const std::string& str){
		return atoi(str.substr(0,10).c_str());
	}
	...
	void vibrate(int milliseconds)
	{
		...
		{
			//调用此函数  
			minfo.env->CallStaticVoidMethod(minfo.classID, minfo.methodID, milliseconds);
		}
#endif	
	}
